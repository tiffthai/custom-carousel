<template>
	<div id="carousel">
		...
		<div id="indicatorContainer">
			<div
				v-for="(dot, dotIndex) in slideData?.length"
				:key="'dot' + dotIndex"
			>
				<div
					class="dotIndicator"
			...
			>
					...
					<div class="ctaContainer">
						...
						>
							<div
								class="ctaButton"
								:class="{
									multipleCTAButtons: slide.cta.length > 1,
								}"
				...
				<picture>
					<source
						...
						:srcset="slide.media.mobile"
					/>
					<source
						media="(min-width: 800px)"
						:srcset="slide.media.desktop"
					/>
					<img src="slide.media.mobile" class="carouselBackgroundImg" />
				</picture>
			</div>
		</transition-group>
	</div>
